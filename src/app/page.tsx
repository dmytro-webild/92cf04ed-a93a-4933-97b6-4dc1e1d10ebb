...
import { Award, Fish, Star, Sun, Users, Utensils, Waves, Wine } from "lucide-react";
...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/portrait-expressive-young-man_273609-6855.jpg",
          alt: "Diner",
        },
        {
          src: "http://img.b2bpic.net/free-photo/unpleased-young-brunette-caucasian-girl-stands-with-crossed-arms_141793-104161.jpg",
          alt: "Diner",
        },
        {
        ...
        },
        {
          ...
          alt: "Smiling young girl",
        },
        {
          src: "http://img.b2bpic.net/free-photo/puzzled-beautiful-young-african-american-woman-fashionable-pink-jacket-reacts-something-with-dissatisfied-expression_273609-45751.jpg",
  ...
  <div id="features" data-section="features">
      ...
      features={[
        ...
        },
        {
          ...
          description: "Private seating options for your special occasion.",
          buttonIcon: "Award",
      ...
      products={[
        {
          ...
          name: "Kingklip",
          price: "R245",
          imageSrc: "http://img.b2bpic.net/free-photo/plate-tasty-salmon-steak-with-sauce-puree-modern-food-restaurant_8353-7022.jpg",
        },
        {
          id: "p2",
          name: "Beef Prego Roll",
          price: "R165",
          imageSrc: "http://img.b2bpic.net/free-photo/juicy-beef-wellington-tenderloin-dish-rustic-wooden-table-english-food-ai-generative_123827-24944.jpg",
        },
        {
          id: "p3",
          name: "Seafood Platter",
          price: "R495",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-assortment-seafood-with-mussels-squid_23-2148643584.jpg",
        },
        {
          id: "p4",
        ...
        },
        {
          ...
          price: "R120",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-fresh-vegetable-salad-with-sliced-cucumbers-tomatoes-olive-white-cheese-inside-plate-with-tomatoes-dark-blue-surface-vegetable-food-salad-meal-snack_140725-38003.jpg",
        },
        {
          id: "p6",
          name: "Signature Cocktail",
          price: "R95",
          imageSrc: "http://img.b2bpic.net/free-photo/orange-cocktail-table-with-plants_140725-3868.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Sarah",
          handle: "@sarah_durban",
          testimonial: "The atmosphere is comfy and chill with a lovely view.",
        ...
        },
        {
          ...
          name: "Mark",
          handle: "@mark_foodie",
          testimonial: "The kingklip was divine. Truly fresh.",
        ...
        },
        {
          ...
          testimonial: "Tender and delicious steak. Beautiful setting.",
        ...
        },
        {
          ...
          name: "Jason",
          handle: "@jason_coast",
          testimonial: "Exceptional service and beautiful ocean views.",
        ...
        },
        {
          ...
          name: "Chloe",
          handle: "@chloe_dining",
          testimonial: "My favorite spot in Durban North. Pure luxury.",
      ...
      blogs={[
        {
          id: "b1",
          category: "Food",
          title: "The Art of Seafood",
          excerpt: "How we source our fresh daily catches.",
          ...
          authorName: "Chef",
          authorAvatar: "http://img.b2bpic.net/free-photo/pretty-woman-with-space-buns-yellow-turtleneck_273609-6929.jpg",
          date: "Oct 12",
        },
        {
          id: "b2",
          category: "Lifestyle",
          title: "Sunsets & Sangria",
          excerpt: "Your guide to perfect terrace afternoons.",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-cocktail-with-straw_1203-1745.jpg",
          authorName: "Manager",
          authorAvatar: "http://img.b2bpic.net/free-photo/close-up-model-posing_23-2149154619.jpg",
          date: "Oct 10",
        },
        {
          id: "b3",
          category: "Wine",
          title: "Mediterranean Pairings",
          excerpt: "Best wines for our Portuguese chicken.",
          imageSrc: "http://img.b2bpic.net/free-photo/delicious-picnic-still-life_23-2149419733.jpg",
          authorName: "Sommelier",
          authorAvatar: "http://img.b2bpic.net/free-photo/anxious-young-brunette-caucasian-girl-stands-with-crossed-arms-isolated-orange-wall-with-copy-space_141793-116438.jpg",
          date: "Oct 05",
        },
      ]}
    />
      ...
      faqs={[
        {
          ...
          content: "Booking is recommended, especially for sunset seating.",
        },
        {
          id: "f2",
          title: "Is there parking available?",
          content: "Yes, secure parking is provided on-site.",
        },
        {
          id: "f3",
          title: "Are children welcome?",
          content: "We are family-friendly and offer a dedicated kids menu.",
        },
      ]}
